...
const app = Vue.createApp({
  data() {
    return {
      ...
      skillsItems: [
        {
          ...
          imgUrl: 'assets/images/skills/anydesk.png',
          title: 'AnyDesk'
        }, {
          imgUrl: 'assets/images/skills/asana.png',
          title: 'Asana'
        }, {
          imgUrl: 'assets/images/skills/canva.png',
          title: 'Canva'
        }, {
          imgUrl: 'assets/images/skills/cloudways.png',
          title: 'Cloudways'
        }, {
          imgUrl: 'assets/images/skills/discord.png',
          title: 'Discord'
        }, {
          imgUrl: 'assets/images/skills/dynamics365.png',
          title: 'Dynamics 365'
        }, {
          imgUrl: 'assets/images/skills/gitea.png',
          title: 'Gitea'
        }, {
          imgUrl: 'assets/images/skills/gsuite.png',
          title: 'Gsuite'
        }, {
          imgUrl: 'assets/images/skills/helpscout.png',
          title: 'Helpscout'
        }, {
      ...
      toolsItems: [
        {
          imgUrl: 'assets/images/skills/microsoftoffice.png',
          title: 'Office 365'
        }, {
          imgUrl: 'assets/images/skills/powerbi.png',
          title: 'PowerBi'
        }, {
          imgUrl: 'assets/images/skills/wordpress.png',
          title: 'Wordpress'
        }, {
          imgUrl: 'assets/images/skills/teamviewer.png',
          title: 'Teamviewer'
        }, {
          imgUrl: 'assets/images/skills/openai.png',
          title: 'ChatGPT'
        }, {
          ...
          imgUrl: 'assets/images/skills/zoom.png',
          title: 'Zoom'
        }
      ],
      ...
      experienceItems: [
         {
          date: '2017',
          companyName: { en: 'Dangote Cement PLC', ar: '' },
          jobTitle: { en: 'IT SUPPORT OFFICER (INTERN)', ar: '' },
          desc: {
            en: 'I was responsible for diagnosing and troubleshooting technical issues related to hardware, software, and networking within the office.',
            ar: ''
          }
        }, {
          date: '2019',
          companyName: { en: 'Olusola Adegbemile and Associates(Law Firm)', ar: '' },
          jobTitle: { en: 'Junior IT Support Data officer', ar: '' },
          desc: {
            en: 'I was responsible for installing and configuring computer hardware, software, systems, networks, printers and scanners and monitoring/maintaining computer systems and networks.',
            ar: ''
          }
        }, {
          date: '2022',
          companyName: { en: 'Tek Experts', ar: '' },
          jobTitle: { en: 'Technical Support Engineer', ar: '' },
          desc: {
            en: 'I was responsible for diagnosing and troubleshooting technical issues related to hardware, software, and networking/Provide technical support to clients (Microsofts’ end-users) remotely (M365 and Windows).',
            ar: ''
          }
        }, {
          date: '2023',
          companyName: { en: 'Dangote Cement Plc', ar: '' },
          jobTitle: { en: 'Sales Analyst/ Admnistration Officer', ar: '' },
          desc: {
            en: 'Responsible for providing support to customers by raising their orders for products they purchase and spooling/analyzing data related to customer performance to identify trends and areas for improvement.',
            ar: ''
          }
        }, {
          date: '2021-D',
          companyName: { en: 'Upwork', ar: '' },
          jobTitle: { en: 'Freelance Technical Customer Support Specialist/ Virtual Assistant', ar: '' },
          desc: {
            en: 'Freelancer: Responsible for providing support to customers by raising their orders for products they purchase and spooling/analyzing data related to customer performance to identify trends and areas for improvement.',
            ar: ''
          }
        }
      ],
      ...
      allPortfolioItems: [
        {
          url: 'https://www.upwork.com/freelancers/~01a3d34e1a86fdf9d3',
